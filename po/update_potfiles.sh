...
find ../data/ui ../src/plugins -iname "*.glade" -or -iname "*.xml" -or -iname "*.ui" -or -iname "*.ui.in" | xargs xgettext --package-name=$APPNAME --package-version=$version --from-code=UTF-8 --output=$APPNAME-glade.pot -L Glade
